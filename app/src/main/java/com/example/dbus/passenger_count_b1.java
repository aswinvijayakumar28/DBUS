...
public class passenger_count_b1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_passenger_count_b1);
        ...
        myRef = database.getReference().child("bus").child("1001").child("route");
        ...
        myRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                RecyclerView.LayoutManager layoutmanager = new LinearLayoutManager(passenger_count_b1.this);
